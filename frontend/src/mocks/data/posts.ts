...
export const mockPosts = [
  ...
  },
  {
    id: 3,
    contentPreview:
      '인증된 치료사만 볼 수 있는 케이스 스터디입니다. ADHD 진단을 받은 7세 아동의 인지행동치료 6개월 경과 보고...',
    content:
      '인증된 치료사만 볼 수 있는 케이스 스터디입니다.\n\nADHD 진단을 받은 7세 아동의 인지행동치료 6개월 경과 보고\n\n초기 평가:\n- 주의집중 시간: 3분\n- 과제 완수율: 20%\n\n6개월 후:\n- 주의집중 시간: 12분\n- 과제 완수율: 65%\n\n사용한 기법과 세션별 변화를 상세히 공유드립니다.',
  ...
  },
  {
    id: 4,
    contentPreview:
      '놀이치료에서 경계선 설정이 어려운 아이가 있는데, 선배 치료사분들 조언 부탁드려요. 5세 남아인데 세션 중에 치료실 밖으로 나가려고 하고...',
    content:
      '놀이치료에서 경계선 설정이 어려운 아이가 있는데, 선배 치료사분들 조언 부탁드려요.\n\n5세 남아인데 세션 중에 치료실 밖으로 나가려고 하고, 장난감을 던지는 행동이 반복돼요.\n\n제가 시도해본 것들:\n- 타이머 활용 → 효과 미미\n- 시각적 규칙판 → 처음엔 관심 보이다가 곧 무시\n- 선택지 제공 → 때때로 효과 있음\n\n비슷한 경험 있으신 분들 어떻게 대처하셨는지 궁금합니다.',
    therapyArea: 'PLAY',
    viewCount: 156,
    commentCount: 15,
    hasAttachment: false,
  ...
  },
  {
    id: 5,
    contentPreview:
      '치료사 2년차인데 번아웃이 왔어요. 하루에 세션을 6~7개씩 하다 보니 체력적으로도 정신적으로도 지치네요...',
    content:
  ...
  },
  {
    id: 6,
    contentPreview:
      '인증 치료사 전용 자료입니다. 작업치료 평가 도구 비교표 (COPM, BOT-2, PDMS-2) 정리했습니다...',
    content:
  ...
  },
  {
    id: 7,
    contentPreview:
      '치료사 면접 준비 중인데 경험 공유드려요. 저는 작년에 3군데 면접 봤는데 공통적으로 나온 질문들 정리했습니다...',
    content:
      '치료사 면접 준비 중인데 경험 공유드려요.\n\n저는 작년에 3군데 면접 봤는데 공통적으로 나온 질문들 정리했습니다.\n\n1. 왜 이 분야를 선택했나요?\n2. 어려운 케이스를 어떻게 대처했나요?\n3. 보호자와의 갈등 경험?\n4. 팀워크 경험?\n5. 자기계발 계획?\n\n면접 준비하시는 분들 화이팅!',
    therapyArea: 'UNSPECIFIED',
    viewCount: 445,
    commentCount: 31,
    hasAttachment: false,
...
export const mockReactions: Record<
  number,
  { likeCount: number; curiousCount: number; usefulCount: number; myReactionType: string | null }
> = {
